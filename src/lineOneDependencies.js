...
const SeemsUnused = ({}) => (
  <div>
    ...
    <button type="button" className="btn btn-outline btn-sm show-on-focus sortable-button js-sortable-button right-0" data-direction="up">
      <svg aria-label="Move ERRORSCREAM up" className="octicon octicon-chevron-up" viewBox="0 0 10 16" version="1.1" width="10" height="16" role="img">
    ...
    <button type="button" className="btn btn-outline btn-sm show-on-focus sortable-button js-sortable-button right-0" data-direction="down">
      <svg aria-label="Move ERRORSCREAM down" className="octicon octicon-chevron-down" viewBox="0 0 10 16" version="1.1" width="10" height="16" role="img">
